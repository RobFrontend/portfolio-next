    ...
    <div className="min-h-screen relative z-[1] overflow-hidden heroShadow">
      ...
      <div className="max-w-[1200px] grid mx-auto pt-32 justify-items-center gap-8 max-xl:pt-16">
        ...
        <div className="flex justify-between pt-24 z-10 px-8 max-xl:pt-16  w-full">
          <div className="w-[30%] max-sm:w-[50%] divAppearIn">
      ...
      <Image
        src={TranIMG}
        alt="transparent"
        className="absolute h-[55vh] max-sm:h-[45vh]  w-auto bottom-[-5px] right-1/2 translate-x-1/2 opacity-90 hover:opacity-100 transition-all duration-500 tranIMG z-[1] imageAppear"
      />
    </div>
  );
}
