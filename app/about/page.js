    ...
    <>
      ...
      <RevealingSections>
        <section className="max-w-[1200px] mx-auto">
          ...
          <p className="pb-6 text-justify max-sm:text-sm">
            ...
            shop application, primarily for the Italian version but also for
            other regions as needed. This role has given me valuable experience
            in working with international clients and collaborating in a
            fast-paced environment using Jira and Scrum methodologies.
            Additionally, I support various teams by creating websites for
            Samsung&apos;s Polish website (Samsung shop for Poland), both
            through the CMS and by writing raw code using HTML, CSS, and
          ...
          <p className="pb-6 text-justify max-sm:text-sm">
            ...
            I&apos;ve had the opportunity to collaborate with clients on
            projects such as landing pages, company websites, and even
            full-stack applications with blogs. This freelance experience has
            helped me hone my skills in managing projects independently while
      ...
      <RevealingSections>
        <section className="max-w-[1200px] mx-auto">
          ...
          <p className="pb-6 text-justify max-sm:text-sm">
            ...
            Over the months, I expanded my vanilla JavaScript knowledge,
            building projects that combined HTML, CSS, and JavaScript. Creating
            mini-games like &quot;Guess the Player&quot; and &quot;Compare
            Height to Basketball Player&quot; helped me understand how
          ...
          <p className="pb-6 text-justify max-sm:text-sm">
            ...
            deepened my understanding of component-based architecture. From
            there, I embraced optimization techniques like Redux, React Query,
            and memoization, which streamlined connections to databases like
            Supabase.
          </p>
          <p className="pb-6 text-justify max-sm:text-sm">
            Building a blog with a custom CMS, fully integrated with Supabase,
            was a personal achievement. Incorporating Tailwind CSS for rapid UI
            development further elevated my work, enabling me to go from landing
            pages in HTML/CSS to full-scale, independent single-page
            applications (SPA) using React, Tailwind, APIs, and databases.
          </p>
        </section>
      </RevealingSections>
      {/* BACKEND JOURNEY */}
      <RevealingSections>
        <section className="max-w-[1200px] mx-auto">
          ...
          <p className="pb-6 text-justify max-sm:text-sm">
            On the backend, I started with the basics of Node.js, learning how
            to create and launch a server while understanding the differences
            between synchronous and asynchronous operations. These fundamentals
            prepared me for Next.js, which became a key focus in my journey
            after gaining proficiency in frontend development.
          </p>
          <p className="pb-6 text-justify max-sm:text-sm">
            ...
            Next.js projects, including converting a client&apos;s website into
            a full-stack, server-side rendered (SSR) application, which
            dramatically improved its performance and scalability.
          </p>
          <p className="pb-6 text-justify max-sm:text-sm">
            For databases, I currently use Supabase for its ease of integration
            with file storage and authentication features. However, I&apos;m
            eager to deepen my backend knowledge by learning SQL (MySQL or
            PostgreSQL) to eventually code my own databases, aiming for complete
            independence as a web developer.
          </p>
        </section>
      </RevealingSections>
      <Footer />
