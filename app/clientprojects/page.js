            ...
            <div className="grid ">
              ...
              <div className="p-4">
                ...
                <p className="text-justify">
                  ...
                  projects I&apos;ve developed for a client. The website
                  includes five main pages: Home Page, About Me, Collab,
                  Contact, and Blog. It&apos;s dedicated to book enthusiasts,
                  with the blog serving as a platform for book reviews.
                </p>
              </div>
              <div className="grid p-4 gap-4">
                ...
                <p className="text-justify">
                  To provide my client with full control over the blog content,
                  I created a custom CMS, hosted on a separate domain and
                  accessible after authentication. This allows the client to
                  easily add and manage new blog posts. The site also includes a
                  notification system using React Hot Toast, ensuring that the
                  owner stays updated with important actions on the site.
                </p>
              </div>
              <div className="p-4">
                <p className="text-justify">
                  ...
                  stands out for its complexity and attention to user
                  experience, combining a dynamic front-end with a powerful
                  back-end.
                </p>
              </div>
              <Link
            ...
            <div className="grid ">
              ...
              <div className="p-4">
                ...
                <p className="text-justify">
                  ...
                  styled-components and third-party libraries. Created for a
                  local supplement shop, the design is clean, user-friendly, and
                  focused on delivering essential information to the customer.
                  It provides clear details about the shop&apos;s products,
                  contact information, and location, ensuring that users can
                  easily find what they need. The project is fully responsive,
                  offering a smooth browsing experience on any device.
                </p>
              </div>
            ...
            <div className="grid ">
              ...
              <div className="p-4">
                ...
                <p className="text-justify">
                  ...
                  as an &apos;About Us&apos; section, recommended event types
                  for the photobooth, customer reviews (connected to a free
                  Google API), and links to social media platforms like
                  Instagram and TikTok. The vibrant design creates a fun user
                  experience while ensuring the content is clear and easy to
                  navigate.
                </p>
              </div>
